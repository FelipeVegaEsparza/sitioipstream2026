...
if ($slug) {
    ...
    if (!$article) {
        ...
        $og['description'] = htmlspecialchars($article['excerpt'] ?: $article['title']);
...
function render_article($a) {
    ...
    $shareUrl = 'https://' . $_SERVER['HTTP_HOST'] . '/noticias/?slug=' . urlencode($a['slug']);
    $shareText = htmlspecialchars_decode($a['title'] . ' - ' . $shareUrl);
    return '
    <article class="max-w-4xl mx-auto">
        ...
        <div class="mt-12 pt-8 border-t border-gray-200">
            <p class="text-sm text-gray-500 mb-4">Compartir esta noticia:</p>
            <div class="flex space-x-4">
                <a href="https://wa.me/?text=' . urlencode($shareText) . '" target="_blank" rel="noopener" class="inline-flex items-center px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors text-sm font-medium">
                ...
                <a href="https://www.facebook.com/sharer/sharer.php?u=' . urlencode($shareUrl) . '" target="_blank" rel="noopener" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">
                ...
                <a href="https://twitter.com/intent/tweet?text=' . urlencode($shareText) . '" target="_blank" rel="noopener" class="inline-flex items-center px-4 py-2 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors text-sm font-medium">
...
<a href="/pago-mensual" class="block px-4 py-2.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 transition-colors text-sm flex items-center"><svg class="w-4 h-4 mr-2 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>Pago Mensual</a>
            ...
            <div class="flex items-center space-x-3">
                <a href="https://panelipstream.cl/" class="inline-flex items-center bg-gradient-to-r from-green-500 to-emerald-600 text-white px-5 py-2 rounded-xl font-medium shadow-lg transition-all">Ingresar</a>
