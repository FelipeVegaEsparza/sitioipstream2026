...
<div class="flex space-x-5">
  ...
  <a href="<?= h($social['social_facebook']) ?>" target="_blank" rel="noopener" class="text-blue-200 hover:text-white transition-colors transform hover:scale-110" aria-label="Facebook">
  ...
  <a href="<?= h($social['social_twitter']) ?>" target="_blank" rel="noopener" class="text-blue-200 hover:text-white transition-colors transform hover:scale-110" aria-label="Twitter / X">
  ...
  <a href="<?= h($social['social_instagram']) ?>" target="_blank" rel="noopener" class="text-blue-200 hover:text-white transition-colors transform hover:scale-110" aria-label="Instagram">
  ...
  <a href="<?= h($social['social_youtube']) ?>" target="_blank" rel="noopener" class="text-blue-200 hover:text-white transition-colors transform hover:scale-110" aria-label="YouTube">
  ...
  <a href="<?= h($social['social_tiktok']) ?>" target="_blank" rel="noopener" class="text-blue-200 hover:text-white transition-colors transform hover:scale-110" aria-label="TikTok">
